...
export default function AnnouncementBar() {
  ...
  return (
    <motion.div
      ...
      className="bg-black text-white relative overflow-hidden rounded-2xl"
      style={{
        margin: "20px",
        padding: "12px 20px",
      }}
    >
        ...
        <motion.button
          ...
          className="absolute top-2 right-3 z-20 p-1.5 hover:bg-white/10 rounded-full transition-colors duration-200"
